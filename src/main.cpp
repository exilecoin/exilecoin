...
uint256 hashGenesisBlock("0x18bb4a98eca8799d58bf7f9f3bf72415e87d92eacb2d967b1c03fd555ff2ae02");
...
const string strMessageMagic = "ExileCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 0.35 * 24 * 60 * 60; // ExileCoin: 0.35 days
static const int64 nTargetSpacing = 15; // ExileCoin: 15 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal exilecoin miner
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xd7a81cf480213b76a74e061130f72f3ec6e5558eb3d690a34f64f75aafaea8cb");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "Genisis time is set on the 16th of April 2014";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1397653499;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 387211327;

        if (fTestNet)
        {
            block.nTime    = 1397644549;
        ...
        assert(block.hashMerkleRoot == uint256("0xdf53327075af04f8f36a7e686be74b125079ac073536b519f11634021a06ef2c"));
